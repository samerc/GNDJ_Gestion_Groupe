...
export interface PublicSiteConfig { inscriptionsOpen: boolean; content: SiteContent; supportEmail?: string | null; userDomain?: string | null; loginMessage?: string | null }
