...
export interface PublicSiteConfig { inscriptionsOpen: boolean; content: SiteContent; supportEmail?: string | null; userDomain?: string | null; loginMessages?: string[] | null }
