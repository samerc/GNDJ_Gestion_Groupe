...
const sheetVariants = cva(
  // overflow-y-auto: a sheet whose body is taller than the (phone) viewport must scroll, otherwise its
  // bottom content — including footer buttons — clips off-screen with no way to reach it.
  "fixed z-50 gap-4 overflow-y-auto bg-background p-6 shadow-elevated transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
