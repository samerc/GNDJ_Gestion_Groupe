// The dialog of the one-time, SKIPPABLE contact-review popup (the gate is contact-review-popup.tsx, which loads
...
export default function ContactReviewDialog({ memberId, onSkip }: { memberId: string; onSkip: () => void }) {
